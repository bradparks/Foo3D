...
class OpenGLRenderDevice extends AbstractRenderDevice {
	...
	inline static var UNSIGNED_BYTE:Int = 0x1401;
	inline static var FLOAT:Int = 0x1406;
	inline static var RGBA:Int = 0x1908;
	inline static var CULL_FACE:Int = 0x0B44;
	inline static var DEPTH_TEST:Int = 0x0B71;
	inline static var BLEND:Int = 0x0BE2;
	inline static var LINEAR:Int = 0x2601;
	inline static var NEAREST:Int = 0x2600;
	inline static var CLAMP_TO_EDGE:Int = 0x812F;
	inline static var REPEAT:Int = 0x2901;
	inline static var MIRRORED_REPEAT:Int = 0x8370;
	inline static var LINEAR_MIPMAP_NEAREST:Int = 0x2701;
	inline static var LINEAR_MIPMAP_LINEAR:Int = 0x2703;
	inline static var NEAREST_MIPMAP_NEAREST:Int = 0x2700;
	inline static var TEXTURE_MIN_FILTER:Int = 0x2801;
	inline static var TEXTURE_MAG_FILTER:Int = 0x2800;
	inline static var TEXTURE_WRAP_S:Int = 0x2802;
	inline static var TEXTURE_WRAP_T:Int = 0x2803;
	inline static var TEXTURE0:Int = 0x84C0;
	inline static var TEXTURE15:Int = 0x84CF;
	inline static var TEXTURE_CUBE_MAP_POSITIVE_X:Int = 0x8515;
	inline static var DEPTH_BUFFER_BIT:Int = 0x00000100;
	inline static var COLOR_BUFFER_BIT:Int = 0x00004000;
	inline static var STENCIL_BUFFER_BIT:Int = 0x00000400;
	inline static var DEPTH_COMPONENT:Int = 0x1902;
	inline static var VERTEX_SHADER:Int = 0x8B31;
	inline static var FRAGMENT_SHADER:Int = 0x8B30;
	inline static var COMPILE_STATUS:Int = 0x8B81;
	inline static var LINK_STATUS:Int = 0x8B82;
	inline static var ACTIVE_ATTRIBUTES:Int = 0x8B89;
	inline static var ACTIVE_UNIFORMS:Int = 0x8B86;
	inline static var MAX_SAMPLES:Int = 0x8D57;
    inline static var COLOR_ATTACHMENT0:Int = 0x8CE0;
    inline static var DEPTH_ATTACHMENT:Int = 0x8D00;
    inline static var NONE:Int = 0;
	inline static var TEXTURE_COMPARE_MODE:Int = 0x884C;
    inline static var FRAMEBUFFER:Int = 0x8D40;
    inline static var RENDERBUFFER:Int = 0x8D41;
    inline static var DRAW_FRAMEBUFFER:Int = 0x8CA9;
    inline static var READ_FRAMEBUFFER:Int = 0x8CA8;
    inline static var FRAMEBUFFER_UNSUPPORTED:Int = 0x8CDD;
    inline static var FRAMEBUFFER_INCOMPLETE_ATTACHMENT:Int = 0x8CD6;
    inline static var FRAMEBUFFER_INCOMPLETE_MISSING_ATTACHMENT:Int = 0x8CD7;
    inline static var FRAMEBUFFER_COMPLETE:Int = 0x8CD5;
    inline static var MULTISAMPLE:Int = 0x809D;
    ...
    { 
        ...
        if (_samples > maxSamples) {
        	_samples = maxSamples;
        	trace("[Foo3D - WARNING] - GPU doesnt desired multisampling quality for rendertarget!");
        }
    ...
    override function applySamplerState(_tex:RDITexture):Void
    {
        ...
        var magFilters:Array<Int> = [LINEAR, LINEAR, NEAREST];
        var minFiltersMips:Array<Int> = [LINEAR_MIPMAP_NEAREST, LINEAR_MIPMAP_LINEAR, NEAREST_MIPMAP_NEAREST];
        var wrapModes:Array<Int> = [CLAMP_TO_EDGE, REPEAT, MIRRORED_REPEAT];
	...
	// Native Interface
	static var hx_rd_init = cpp.Lib.load("foo3D", "hx_rd_init", 1);
	static var hx_gl_createBuffer = cpp.Lib.load("foo3D", "hx_gl_createBuffer", 0);
	static var hx_gl_bindBuffer = cpp.Lib.load("foo3D", "hx_gl_bindBuffer", 2);
	static var hx_gl_bufferData = cpp.Lib.load("foo3D", "hx_gl_bufferData", 4);
	static var hx_gl_deleteBuffer = cpp.Lib.load("foo3D", "hx_gl_deleteBuffer", 1);
	static var hx_gl_bufferSubData = cpp.Lib.load("foo3D", "hx_gl_bufferSubData", 4);
	static var hx_gl_viewport = cpp.Lib.load("foo3D", "hx_gl_viewport", 4);
	static var hx_gl_scissor = cpp.Lib.load("foo3D", "hx_gl_scissor", 4);
	static var hx_gl_enable = cpp.Lib.load("foo3D", "hx_gl_enable", 1);
	static var hx_gl_disable = cpp.Lib.load("foo3D", "hx_gl_disable", 1);
	static var hx_gl_cullFace = cpp.Lib.load("foo3D", "hx_gl_cullFace", 1);
	static var hx_gl_depthFunc = cpp.Lib.load("foo3D", "hx_gl_depthFunc", 1);
	static var hx_gl_blendFunc = cpp.Lib.load("foo3D", "hx_gl_blendFunc", 2);
	static var hx_gl_activeTexture = cpp.Lib.load("foo3D", "hx_gl_activeTexture", 1);
	static var hx_gl_bindTexture = cpp.Lib.load("foo3D", "hx_gl_bindTexture", 2);
	static var hx_gl_vertexAttribPointer = cpp.Lib.load("foo3D", "hx_gl_vertexAttribPointer", -1);
	static var hx_gl_enableVertexAttribArray = cpp.Lib.load("foo3D", "hx_gl_enableVertexAttribArray", 1);
	static var hx_gl_disableVertexAttribArray = cpp.Lib.load("foo3D", "hx_gl_disableVertexAttribArray", 1);
	static var hx_gl_texParameteri = cpp.Lib.load("foo3D", "hx_gl_texParameteri", 3);
	static var hx_gl_clearDepth = cpp.Lib.load("foo3D", "hx_gl_clearDepth", 1);
	static var hx_gl_clearColor = cpp.Lib.load("foo3D", "hx_gl_clearColor", 4);
	static var hx_gl_clear = cpp.Lib.load("foo3D", "hx_gl_clear", 1);
	static var hx_gl_createTexture = cpp.Lib.load("foo3D", "hx_gl_createTexture", 0);
	static var hx_gl_texImage2D = cpp.Lib.load("foo3D", "hx_gl_texImage2D", -1);
	static var hx_gl_generateMipmap = cpp.Lib.load("foo3D", "hx_gl_generateMipmap", 1);
	static var hx_gl_deleteTexture = cpp.Lib.load("foo3D", "hx_gl_deleteTexture", 1);
	static var hx_gl_createShader = cpp.Lib.load("foo3D", "hx_gl_createShader", 1);
	static var hx_gl_deleteShader = cpp.Lib.load("foo3D", "hx_gl_deleteShader", 1);
	static var hx_gl_compileShader = cpp.Lib.load("foo3D", "hx_gl_compileShader", 1);
	static var hx_gl_shaderSource = cpp.Lib.load("foo3D", "hx_gl_shaderSource", 2);
	static var hx_gl_getShaderiv = cpp.Lib.load("foo3D", "hx_gl_getShaderiv", 2);
	static var hx_gl_getShaderInfoLog = cpp.Lib.load("foo3D", "hx_gl_getShaderInfoLog", 1);
	static var hx_gl_createProgram = cpp.Lib.load("foo3D", "hx_gl_createProgram", 0);
	static var hx_gl_deleteProgram = cpp.Lib.load("foo3D", "hx_gl_deleteProgram", 1);
	static var hx_gl_linkProgram = cpp.Lib.load("foo3D", "hx_gl_linkProgram", 1);
	static var hx_gl_getProgramiv = cpp.Lib.load("foo3D", "hx_gl_getProgramiv", 2);
	static var hx_gl_getProgramInfoLog = cpp.Lib.load("foo3D", "hx_gl_getProgramInfoLog", 1);
	static var hx_gl_attachShader = cpp.Lib.load("foo3D", "hx_gl_attachShader", 2);
	static var hx_gl_getActiveAttrib = cpp.Lib.load("foo3D", "hx_gl_getActiveAttrib", 3);
	static var hx_gl_getAttribLocation = cpp.Lib.load("foo3D", "hx_gl_getAttribLocation", 2);
	static var hx_gl_useProgram = cpp.Lib.load("foo3D", "hx_gl_useProgram", 1);
	static var hx_gl_getActiveUniform = cpp.Lib.load("foo3D", "hx_gl_getActiveUniform", 3);	
	static var hx_gl_getUniformLocation = cpp.Lib.load("foo3D", "hx_gl_getUniformLocation", 2);
	static var hx_gl_uniform1fv = cpp.Lib.load("foo3D", "hx_gl_uniform1fv", 2);
	static var hx_gl_uniform2fv = cpp.Lib.load("foo3D", "hx_gl_uniform2fv", 2);
	static var hx_gl_uniform3fv = cpp.Lib.load("foo3D", "hx_gl_uniform3fv", 2);
	static var hx_gl_uniform4fv = cpp.Lib.load("foo3D", "hx_gl_uniform4fv", 2);
	static var hx_gl_uniformMatrix3fv = cpp.Lib.load("foo3D", "hx_gl_uniformMatrix3fv", 3);
	static var hx_gl_uniformMatrix4fv = cpp.Lib.load("foo3D", "hx_gl_uniformMatrix4fv", 3);
	static var hx_gl_uniform1i = cpp.Lib.load("foo3D", "hx_gl_uniform1i", 2);
	static var hx_gl_drawRangeElements = cpp.Lib.load("foo3D", "hx_gl_drawRangeElements", 3);
	static var hx_gl_drawArrays = cpp.Lib.load("foo3D", "hx_gl_drawArrays", 3);
	static var hx_gl_getIntegerv = cpp.Lib.load("foo3D", "hx_gl_getIntegerv", 1);
    static var hx_gl_genFramebuffer = cpp.Lib.load("foo3D", "hx_gl_genFramebuffer", 0);
    static var hx_gl_genRenderbuffer = cpp.Lib.load("foo3D", "hx_gl_genRenderbuffer", 0);
    static var hx_gl_bindFramebuffer = cpp.Lib.load("foo3D", "hx_gl_bindFramebuffer", 2);
    static var hx_gl_bindRenderbuffer = cpp.Lib.load("foo3D", "hx_gl_bindRenderbuffer", 2);
    static var hx_gl_framebufferTexture2D = cpp.Lib.load("foo3D", "hx_gl_framebufferTexture2D", 2);
    static var hx_gl_renderbufferStorageMultisample = cpp.Lib.load("foo3D", "hx_gl_renderbufferStorageMultisample", 4);
    static var hx_gl_framebufferRenderbuffer = cpp.Lib.load("foo3D", "hx_gl_framebufferRenderbuffer", 2);
    static var hx_gl_drawBuffer = cpp.Lib.load("foo3D", "hx_gl_drawBuffer", 1);
    static var hx_gl_drawBuffers = cpp.Lib.load("foo3D", "hx_gl_drawBuffers", 1);
    static var hx_gl_readBuffer = cpp.Lib.load("foo3D", "hx_gl_readBuffer", 1);
    static var hx_gl_checkFrameBufferStatus = cpp.Lib.load("foo3D", "hx_gl_checkFrameBufferStatus", 0);
    static var hx_gl_deleteRenderbuffer = cpp.Lib.load("foo3D", "hx_gl_deleteRenderbuffer", 1);
    static var hx_gl_deleteFramebuffer = cpp.Lib.load("foo3D", "hx_gl_deleteFramebuffer", 1);
    static var hx_gl_blitFramebuffer = cpp.Lib.load("foo3D", "hx_gl_blitFramebuffer", 3);
